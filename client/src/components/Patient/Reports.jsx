...
const Reports = (props) => {
     ...
     return (
          <Box sx={{ display: "flex", flexDirection: "column", marginLeft: "65px", padding: "20px" }}>
                                   ...
                                   <StyledTableRow key={row.id}>
                                        ...
                                        <StyledTableCell align="center">
                                             <Button
                                                  ...
                                                  variant="contained"
                                                  onClick={(e)=>{handleDownload(e, row.id, row.reportName)}}
                                             >
                                                  Download
                                             </Button>
                                        </StyledTableCell>
               ...
               <Box sx={{ marginTop: "30px" }}>
                    <Button sx={{ float: "right", backgroundColor: "#00ACB9" }} variant='contained' onClick={handleShow}>Upload a new report </Button>
               </Box>
