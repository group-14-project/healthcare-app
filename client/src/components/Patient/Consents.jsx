...
const Consents = () => {
	...
	const patientPendingConsents = useSelector(
		(state) => state.patient.pendingConsents
	);
	const patientApprovedConsents = useSelector(
		(state) => state.patient.approvedConsents
	);
	...
	return (
		<>
			...
			>
				...
				{patientPendingConsents.length === 0 ? (
					<Box sx={{ margin: "auto" }}>
									...
									<StyledTableRow key={index}>
										...
										<StyledTableCell align="center">
											<Button
												...
												onClick={(e) => {
													handleApproveConsent(e, consent.consentId);
												}}
											>
												Approve
											</Button>
											<Button
												...
												color="error"
												onClick={(e) => {
													handleRejectConsentRequest(e, consent.consentId);
												}}
											>
												Reject
											</Button>
				...
				>
					...
					>
						Approved Consents
                         ...
                         {patientApprovedConsents.length === 0 ? (
					<Box sx={{ margin: "auto" }}>
						You have not approved any consents as of now
					</Box>
				) : (
					<TableContainer component={Paper}>
						<Table sx={{ minWidth: 700 }} aria-label="customized table">
									...
									<StyledTableRow key={index}>
										...
										<StyledTableCell align="center">
											<Button
												...
												style={{ marginRight: "15px" }}
												onClick={(e) => {
													handleWithdrawConsent(e, consent.consentId);
												}}
											>
												Withdraw
											</Button>
