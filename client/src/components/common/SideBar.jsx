    ...
    <Box className="sidebar-parent" >
      ...
      <ThemeProvider theme={SidebarTheme}>
        <Drawer variant="permanent" open={open}>
          ...
          <Divider />
          <List>
            {['Consult', 'Reports', 'Prescriptions', 'Past Appointments', 'Upcoming Appointments', 'Logout'].map((text, index) => (
              <ListItem key={text} disablePadding className='sidebar-list-item'>
               ...
               sx={{
                ...
                >
                  ...
                  >
                    {index==0?<DuoSharpIcon/>:index==1?<SummarizeSharpIcon/>:index==2?<MedicationSharpIcon/>:index==3?<UndoSharpIcon/>:index==4?<UpdateSharpIcon/>:<LogoutSharpIcon/>}
                  </ListItemIcon>
